...
if("FALSE" STREQUAL "TRUE")
  set(omni_description_SOURCE_PREFIX /home/andy/eye_op_robot_mixed/src/omni_packages/omni_description)
  set(omni_description_DEVEL_PREFIX /home/andy/eye_op_robot_mixed/devel)
  ...
  set(omni_description_INSTALL_PREFIX /home/andy/eye_op_robot_mixed/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'omni_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/andy/eye_op_robot_mixed/install/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND omni_description_EXPORTED_TARGETS ${${omni_description_dep}_EXPORTED_TARGETS})
endforeach()
